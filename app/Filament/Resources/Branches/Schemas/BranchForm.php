    ...
    public static function configure(Schema $schema): Schema
    {
        ...
        return $schema
            ->components([
                ...
                // ── Sección 2: Horario Regular ──────────────────────────
                Section::make('Horario Regular')
                    ->description('Define el horario semanal de la sucursal. Puedes agregar múltiples turnos por día (ej: mañana y tarde).')
                ...
                // ── Sección 3: Horarios Especiales ──────────────────────
                Section::make('Horarios Especiales')
                    ->description('Define horarios para fechas específicas (feriados, eventos). Estos tienen prioridad sobre el horario regular.')
