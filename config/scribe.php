...
return [
    ...
    'title' => 'AXStore API — Documentación',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API REST para la aplicación móvil de AXStore. Gestión de productos, pedidos, direcciones y autenticación de clientes.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtén tu token usando `POST /api/v1/auth/login` o `POST /api/v1/auth/register`. Envía el token en el header: `Authorization: Bearer {token}`.',
    ],
